        ...
        <div id="carouselExampleIndicators" class="carousel slide mt-1" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img  class="d-block" src="image/b1.jpeg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block" src="image/b2.jpeg" alt="Second slide">
              </div>
              <div class="carousel-item">
                      ...
                      <div class='card card-product mb-3'>
                            ...
                            <div class='card-body'>
                                ...
                                <p style='color: red'><b>Price: $SongPrice </b>$</p>
                                   <div align='center'>
                                     <a href='detail.php?id=$SongID'><button class='btn btn-dark' ; style='float: left;'>Details</button></a>
                                   </div>
                            </div>
                      </div>
                    </div>
